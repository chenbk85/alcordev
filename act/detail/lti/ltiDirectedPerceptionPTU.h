...
//port_params.port = lti::serial::parameters::Com5;
//port_params.receiveTimeout = 150;
////
//lti::directedPerceptionPTU::parameters par;
//par.connectionToPTU.setParameters(port_params);
//m_ptu.setParameters(par);
//if(m_ptu.initialize())
//	{
//	m_ptu.setAngleFormat(lti::panTiltUnit::parameters::Degrees);
//	m_ptu.setPanSpeed(2200);
//	m_ptu.setTiltSpeed(2200);
//	}

//void mt9_logger::head_()
//		{
//#ifdef USE_PTU
//		float panpos  = mt9_curr.yaw;
//		float tiltpos = mt9_curr.pitch;
//
//		panpos=( (mt9_curr.yaw > m_ptu.getMinPan())? (mt9_curr.yaw):(m_ptu.getMinPan()) );
//		panpos =( (panpos < m_ptu.getMaxPan())? (panpos):(m_ptu.getMaxPan()) );
//		//
//		tiltpos=( (mt9_curr.pitch > m_ptu.getMinTilt())? (mt9_curr.pitch):(m_ptu.getMinTilt()) );
//		tiltpos =( (tiltpos < m_ptu.getMaxTilt())? (tiltpos):(m_ptu.getMaxTilt()) );
//
//		mt9_curr.yaw = panpos;
//		mt9_curr.pitch= tiltpos;
//		m_ptu.setPanTilt(panpos,tiltpos);
//
//		m_ptu.awaitPosCommandCompletion();
//		while ( !m_ptu.isPTUidle() ) 
//			{}
//#endif
//		}
/*--------------------------------------------------------------------
